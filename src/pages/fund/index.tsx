          ...
          <div className='flex flex-col justify-center max-w-2xl mx-auto'>
            ...
            <div className='text-left my-4 break-words'>
              ...
              <p className='py-2 text-md'>
                OpenLiquid Open Source Fund is a fund that is managed by OpenLiquid Capital and powered by OpenLiquid's <Link href='/orbit' className='text-decoration-none border-b-2 rounded-sm px-0 py-0 border-indigo-800 hover:bg-indigo-800 hover:text-zinc-200'>ORBIT</Link>. The fund is a pool of money collected at the beginning of each quarter, with dividends, interest, and capital gains paid out or reinvested at the each asset's discretion.
